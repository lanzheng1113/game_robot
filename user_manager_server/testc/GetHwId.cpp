...
int GenCode()
{
	...
	ret = GetBiosSn();printf("\nGetBiosSn returned %d", ret);
	BYTE szSystemInfoTemp[129] = {0};
	memcpy(szSystemInfoTemp,szSystemInfo,129);
	memset(szSystemInfo,0,sizeof(szSystemInfo));
	SimpleXor_Crype((char*)szSystemInfo,(char*)szSystemInfoTemp,128); //将加密过的放到szSystemInfo
/*	printf("\nChar:\n");
